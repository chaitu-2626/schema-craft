...
- `@schema-craft/eslint`: `eslint` configurations (includes `eslint-config-next` and `eslint-config-prettier`)
- `@schema-craft/typescript-config`: `tsconfig.json`s used throughout the monorepo
